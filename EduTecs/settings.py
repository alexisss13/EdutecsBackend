...
SECRET_KEY = 'django-insecure-5^iaz@_e!miw+2920*%iazm314g@au--v6m&y@6)&60gb@d^l-'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Binevenido al panel de administración - Edutecs",
...
STATICFILES_DIRS = [
    BASE_DIR / "static",
    # otras carpetas estáticas si las tienes
]
